...
if(iniciar_sesion){
  iniciar_sesion.onclick = function(event){
    ...
    if (userData.username === username && userData.password === password){
      ...
      sign_in_btn.style.display = "none";
      boton_register.style.display = "none";
      mi_perfil.style.display = "block";
      mis_cartas.style.display = "block";
...
var cerrar_perfil = document.getElementById("close-perfil");
cerrar_perfil.onclick = function(){
  pop_up_perfil.style.display = "none";
}
...
cerrar_sesion.onclick = function(){
  if (confirm("¿Estás seguro de que quieres cerrar sesión?")){
    ...
    sign_in_btn.style.display = "block";
    boton_register.style.display = "block";
    mi_perfil.style.display = "none";
    mis_cartas.style.display = "none";
...
mis_cartas.onclick = function() {
  var cartas = cartasContainer.getElementsByClassName("cartas");
  if (cartas.length === 0) {
